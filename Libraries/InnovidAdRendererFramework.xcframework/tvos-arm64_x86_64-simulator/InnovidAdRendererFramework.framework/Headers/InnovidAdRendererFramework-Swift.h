...
#ifndef INNOVIDADRENDERERFRAMEWORK_SWIFT_H
#define INNOVIDADRENDERERFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InnovidAdRendererFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface AVPlayer (SWIFT_EXTENSION(InnovidAdRendererFramework))
@property (nonatomic, readonly, copy) NSString * _Nonnull debugDescription;
@end


@interface AVPlayerItem (SWIFT_EXTENSION(InnovidAdRendererFramework))
@property (nonatomic, readonly, copy) NSString * _Nonnull debugDescription;
@end


@interface AVURLAsset (SWIFT_EXTENSION(InnovidAdRendererFramework))
@property (nonatomic, readonly, copy) NSString * _Nonnull debugDescription;
@end


/// Button on choice card screen
SWIFT_CLASS("_TtC26InnovidAdRendererFramework16ChoiceCardButton")
...
SWIFT_CLASS("_TtC26InnovidAdRendererFramework15InnovidAdParams")
...
/// InnovidAdRenderer interface
SWIFT_PROTOCOL("_TtP26InnovidAdRendererFramework17InnovidAdRenderer_")
...
SWIFT_PROTOCOL("_TtP26InnovidAdRendererFramework25InnovidAdRendererDelegate_")
...
SWIFT_CLASS("_TtC26InnovidAdRendererFramework23InnovidAdRendererParams")
...
SWIFT_PROTOCOL("_TtP26InnovidAdRendererFramework15InnovidDelegate_")
...
SWIFT_CLASS("_TtC26InnovidAdRendererFramework15InnovidProvider")
...
@interface InnovidProvider (SWIFT_EXTENSION(InnovidAdRendererFramework))
/// iRoll
...
SWIFT_CLASS("_TtC26InnovidAdRendererFramework12LiveAdParams")
...
SWIFT_CLASS("_TtC26InnovidAdRendererFramework12SSAIAdParams")
@interface SSAIAdParams : InnovidAdParams
- (nonnull instancetype)initWithShowName:(NSString * _Nullable)showName showGenre:(NSString * _Nullable)showGenre OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC26InnovidAdRendererFramework13TrueXAdParams")
